...
INSERT INTO `products` (`id`, `id_category`, `sizes`, `name`, `price`, `sale`, `title`, `highlight`, `new_product`, `detail`, `createddate`, `modifieddate`) VALUES
...
(6, 1, 'L,S,M', 'Bông tai bạc', '200000', 0, 'tital', 1, 0, 'details', '2020-04-09 11:38:43', '2020-04-09 11:38:43'),
...
insert into users(email,password,display_name,status)
values('admin@gmail.com','$2a$10$/RUbuT9KIqk6f8enaTQiLOXzhnUkiwEJRdtzdrMXXwU7dgnLKTCYG','Nguyễn Văn Dũng',1);
insert into users(email,password,display_name,status)
values('nguyenvana@gmail.com','$2a$10$/RUbuT9KIqk6f8enaTQiLOXzhnUkiwEJRdtzdrMXXwU7dgnLKTCYG','nguyễn Văn An',1);
insert into users(email,password,display_name,status)
values('nguyenvanb@gmail.com','$2a$10$/RUbuT9KIqk6f8enaTQiLOXzhnUkiwEJRdtzdrMXXwU7dgnLKTCYG','nguyễn Văn Bình',1);
